...
set_property PACKAGE_PIN U1 [get_ports en_dists_in]					
	set_property IOSTANDARD LVCMOS33 [get_ports en_dists_in]
set_property PACKAGE_PIN T1 [get_ports en_dists_cm]					
	set_property IOSTANDARD LVCMOS33 [get_ports en_dists_cm]
#set_property PACKAGE_PIN R2 [get_ports en_dists_in]					
	#set_property IOSTANDARD LVCMOS33 [get_ports en_dists_in]
 

## LEDs
set_property PACKAGE_PIN U16 [get_ports comparator_led]					
	set_property IOSTANDARD LVCMOS33 [get_ports comparator_led]
...
#set_property PACKAGE_PIN U17 [get_ports reset]#[get_ports {buttons[2]}] # btnd				
#	set_property IOSTANDARD LVCMOS33 [get_ports reset]#[get_ports {buttons[2]}]
...
##Sch name = JA2
set_property PACKAGE_PIN L2 [get_ports comparator]					
...
set_property PACKAGE_PIN A14 [get_ports pwm_out]					
	set_property IOSTANDARD LVCMOS33 [get_ports pwm_out]
##Sch name = JB2
set_property PACKAGE_PIN A16 [get_ports comparator]					
	set_property IOSTANDARD LVCMOS33 [get_ports comparator]
##Sch name = JB3
